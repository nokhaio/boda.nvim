...
function M.set_groups()
  local groups = {
    ...
    VisualNC = { bg = colors.selection_inactive },
    ...
    ['@lsp.type.parameter'] = { fg = colors.other },
	...
	-- CPP
    ['@variable.builtin.cpp'] = { fg = colors.other },
